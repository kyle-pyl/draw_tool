...
| 项目 | 状态 |
|---|---|
| 阶段 | 阶段 1：Schema 和核心模型 |
| 版本 | 0.1.0 |
| 可用功能 | 核心类型已定义（scene.json 结构、元素模型、图层、连接线、图表等），错误码和校验结果类型已定义，scene.json Schema 结构校验器已实现（含引用完整性校验），validator 支持 REF_LAYER_NOT_FOUND / REF_GROUP_NOT_FOUND / REF_CONNECTOR_ENDPOINT_NOT_FOUND 错误检测 |
...
| 任务清单 | 完整有序的开发任务列表 | docs/task-list.md | 2026-05-18 | T-00-01 |
| 任务日志 | 每个任务的完成记录 | docs/task-log.md | 2026-05-19 | T-01-04 |
| 接口/函数文档 | 项目所有公开接口的注册表 | docs/api-registry.md | 2026-05-19 | T-01-04 |
